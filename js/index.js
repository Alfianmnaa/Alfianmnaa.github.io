...
button.addEventListener("click", function (e) {
  ...
  if (input1.valueAsNumber < input2.valueAsNumber) {
    ...
    demo.innerHTML = `Hasil Permutasi Dari <strong> P(${valInp1},${valInp2}) </strong> adalah <strong> ${hasil / hasil2} </strong>`;
    rumus.innerHTML = `Formula: P(n,r) = n! / (n-r)! <br><br>
    In this example we have n = ${input1.value} and r = ${input2.value}. By Putting these values in above formula, we have: <br><br>
    P(n,r) = ? <br><br>
    P(n,r) = P(${input1.value},${input2.value}) <br><br>
    = ${input1.value}! / (${input1.value} - ${input2.value})! <br><br>
    = ${input1.value}! / ${ndikurangr}! <br><br>
    = ${hasil / hasil2}`;
  }
});
